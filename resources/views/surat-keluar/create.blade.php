        ...
        <div class="container-fluid"> <!--begin::Row-->
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <!--begin::Form-->
                    <form id="suratForm" action="{{route('surat-keluar-post')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Body-->
                        <div class="card-body">
                            <div class="mb-1">
                            ...
                            <div class="mb-1">
                                ...
                                <textarea name="note" class="form-control" style="width: 100%; height:150px;" id="note"></textarea>
                            </div>
                            <div class="mb-1">
